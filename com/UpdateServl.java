...
public class UpdateServl extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            PreparedStatement preparedStatement= connection.prepareStatement(" update person set firstname='"+firstname
                    +"' , number="+number+" where email='"+emailnew+"'");
...
//            ResultSet resultSet = statement.executeQuery("select * from person where email='"+emailnew+"'");
                ...
                printWriter.println("user update successfully");
